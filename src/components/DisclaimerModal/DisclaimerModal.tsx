    ...
    if (step === 'disclaimer') {
      return (
        <div>
          <p>Audits: None.</p>
          <p>
            While the initial creators of the Emoji protocol have made
      ...
      return (
        <div>
          <p>Attention EMOJI Uniswap LPs</p>
          <p>
            The only Uniswap pool that is compatible with EMOJI is EMOJI/yCRV
            (Curve yPool tokens)
          </p>
