...
import EmojiAbi from './abi/emoji.json'
...
export class Contracts {
  constructor(provider, networkId, web3, options) {
    ...
    this.emoji = new this.web3.eth.Contract(EmojiAbi)
  ...
  setProvider(provider, networkId) {
    ...
    setProvider(this.emoji, contractAddresses.emoji[networkId])
  ...
  setDefaultAccount(account) {
    this.emoji.options.from = account
